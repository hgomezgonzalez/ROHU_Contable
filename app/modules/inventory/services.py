...
def create_category(
    ...
    tax_rates = {"iva_19": Decimal("19.0"), "iva_5": Decimal("5.0"), "exempt": Decimal("0"), "excluded": Decimal("0")}
...
def get_categories(tenant_id: str) -> list:
    ...
    cats = Category.query.filter_by(tenant_id=tenant_id, is_active=True).order_by(Category.name).all()
    ...
    if cost > 0:
        ...
        if movement_type == "adjustment_positive":
            ...
            lines = [
                ...
                {"puc_code": "4210", "debit": 0, "credit": float(cost), "description": "Sobrante inventario"},
            ]
        else:
            ...
            lines = [
                ...
                {"puc_code": "1435", "debit": 0, "credit": float(cost), "description": "Merma/faltante inventario"},
            ]
        create_journal_entry(
            tenant_id=tenant_id,
            created_by=created_by,

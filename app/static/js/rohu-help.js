...
const ROHU_HELP = {
  ...
  pos: {
    ...
    steps: [
      'Escriba el nombre del producto o escanee con pistola lectora — aparece un menú desplegable.',
      'Use ↑↓ para navegar y Enter para agregar al carrito.',
      'Use + y - para ajustar la cantidad del último producto.',
      'Presione F12 para abrir el cobro. Escriba el monto y Enter para confirmar.',
      'En el recibo presione Enter para iniciar una nueva venta.',
    ],
    tip: 'Atajos: F2=Buscar, F12=Cobrar, Enter=Agregar/Confirmar, Esc=Cancelar, Alt+E/N/D/T/C=Método de pago.',
  },
  inventory: {
    title: 'Inventario',
  ...
  cash: {
    ...
    steps: [
      ...
      'En "Gastos Operativos" registre arriendo, servicios, nómina, transporte e impuestos.',
      'Cada operación genera automáticamente el asiento contable.',
    ],
    tip: 'Los gastos operativos se clasifican automáticamente en las cuentas PUC correctas (arriendo→5160, servicios→5135, etc.).',
  },
  reports: {
    title: 'Reportes',
  ...
  accounting: {
    ...
    steps: [
      ...
      'En Apertura puede cargar los saldos iniciales de su negocio (caja, bancos, inventario, deudas).',
    ],
    tip: 'Cerrar un mes es como "congelar" ese periodo. Solo diciembre genera el asiento de cierre anual. La apertura solo se hace una vez.',
  },
  admin_settings: {
